...
| Project | Power-Up | Impact Meter | Description |
| :--- | :--- | :---: | :--- |
| **[AEO Audit](https://aeo-audit.sh/)** | `AI Audit Tool` | █████ | Audit your site's GEO & AEO readiness — see how AI agents parse, interpret, and represent your website. Used to audit **10k+ sites**. |
| **[Improve Website AEO/GEO Skill](https://github.com/onvoyage-ai/improve-website-aeo-geo-skill)** | `Claude Code Skill` | █████ | Claude Code skill that audits your codebase against 16 foundational checks and 6 GEO content quality dimensions, then makes framework-specific fixes to boost your AEO score. |
...
| **[Claude for Crypto Deep Research](https://github.com/juntoku9/claude-for-crypto-research)** | `Research Engine` | ████░ | AI-driven tool that synthesizes complex crypto market data and whitepapers. |
